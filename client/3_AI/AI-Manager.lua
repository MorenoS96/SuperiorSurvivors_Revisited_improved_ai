...
require "0_Utilities/SuperSurvivorsCombatUtilities"
...
function AIManager(TaskMangerIn)
    ...
    local vehicle = ASuperSurvivor:Get():getVehicle()
    if vehicle ~= nil and (not CanShootFromVehicle(ASuperSurvivor)) then
        return TaskMangerIn
    end
